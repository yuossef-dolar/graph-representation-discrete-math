...
class Graph:
    """Class 3ashan yemathal graph باستخدام adjacency list"""
    ...
    def visualize(self, title="Graph Visualization", highlight_path=None):
        """
        Rasem el graph باستخدام matplotlib w networkx
        Momken كمان تعمل highlight le path mo3ayan (zay natig BFS)
        """
        G = nx.Graph()
        ...
        # Layout algorithm 3ashan el positioning yeb2a ثابت
